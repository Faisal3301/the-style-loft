...
export default function Header({
    ...
    return (
        <>
            ...
            <header className="animated-header mobile-header-container" style={{ backgroundColor: "#0f172a", color: "#ffffff", padding: "12px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "10px", position: "sticky", top: 0, zIndex: 1000, width: "100%", boxSizing: "border-box" }}>

                {/* Left: Sidebar Menu & Logo linked to Home */}
                ...
                {/* Center: Search Bar */}
                <div className="mobile-search-bar" style={{ display: "flex", flex: "1", maxWidth: "500px", minWidth: "220px", borderRadius: "8px", overflow: "hidden", backgroundColor: "#ffffff", border: isSearchFocused ? "2px solid #f59e0b" : "2px solid transparent", transition: "all 0.3s ease", boxShadow: "0 2px 8px rgba(0,0,0,0.15)" }}>
                    <select
                    ...
                    <input
                        type="text"
                        placeholder={country === "US" ? "Search items..." : "Search styles..."}
                        value={searchQuery}
                ...
                {/* Right: Sign In / Profile Dropdown & Cart Icon */}
